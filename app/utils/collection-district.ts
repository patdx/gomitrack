...
import type { CollectionArea } from './collection-area'
import { getDatabase } from './database'
import type { GarbageType } from './garbage-type'
import type { GarbageTypeFrequency } from './garbage-type-frequency'
import { nextDate } from './garbage-type-frequency'
